...
const CollapsibleSectionTitle = ({
  ...
  <TouchableOpacity onPress={onPress} activeOpacity={0.75} style={styles.sectionHeaderRow}>
    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      >
        <View style={styles.topSection}>
          <SearchBar value={searchQuery} onChange={setSearchQuery} placeholder={t('menu.searchPlaceholder')} />
        </View>
...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 18, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1 },
